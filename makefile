...
numcpp: main.o functions.o misc.o parser.o variables.o routines.o
	g++ main.o functions.o misc.o parser.o variables.o routines.o -o numcpp
main.o: src/main.cpp
	g++ -c src/main.cpp
...
variables.o: src/variables.cpp src/variables.h src/parser.hpp
	g++ -c src/variables.cpp src/variables.h src/parser.hpp
routines.o: src/routines.cpp src/routines.h src/parser.hpp
	g++ -c src/routines.cpp src/routines.h src/parser.hpp
clean:
	rm -rf *o numcpp
